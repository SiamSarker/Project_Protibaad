...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1942669536ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=protibaad&table=crimealert">`protibaad`.`crimealert`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=protibaad&table=blog">`protibaad`.`blog`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=protibaad&table=users">`protibaad`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=protibaad&table=uploads">`protibaad`.`uploads`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=protibaad_&table=users">`protibaad_`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="70605e595d3d21213c5828315e22516d">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="protibaad_" targettable="">
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="protibaad_" targettable="">
                            <div class="action_content">
...
CREATE TABLE `uploads` (
  ...
  `status` varchar(225) NOT NULL DEFAULT &#039;not approved yet&#039;
                            ...
                            targetdb="protibaad_" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="protibaad" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `uploads` (
  `file_id` int(11) NOT NULL,
  `file_name` varchar(225) NOT NULL,
  `file_description` text NOT NULL,
  `file_type` varchar(225) NOT NULL,
  ...
  `status` varchar(225) NOT NULL DEFAULT &#039;not approved yet&#039;
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="protibaad" targettable="uploads">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `uploads`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="protibaad" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `blog` (
  `file_id` int(11) NOT NULL,
  ...
  `status` varchar(225) NOT NULL DEFAULT &#039;not approved yet&#039;
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="protibaad" targettable="blog">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `blog`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="protibaad" targettable="">
                            <div class="action_content">
  ...
  `status` varchar(225) NOT NULL DEFAULT &#039;not approved yet&#039;
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `blog`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="protibaad" targettable="crimealert">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `crimealert`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="protibaad" targettable="uploads">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `uploads`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="protibaad" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
