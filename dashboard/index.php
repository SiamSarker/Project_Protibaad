...
while ($row = mysqli_fetch_array($run_query)) {
    ...
    echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to approve this alert?')\"href='?approve=$file_id'><i class='fa fa-times' style='color: red;'></i>Approve</a></td>";

    echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to delete this alert?')\" href='?del=$file_id'><i class='fa fa-times' style='color: red;'></i>delete</a></td>";
 ...
 <?php
    ...
    if (isset($_GET['del'])) {
        ...
        if (mysqli_affected_rows($conn) > 0) {
            echo "<script>alert('Alert deleted successfully');
        ...
        if (mysqli_affected_rows($conn) > 0) {
            echo "<script>alert('Alert approved successfully');
            window.location.href='index.php';</script>";
        }
        else {
         echo "<script>alert('error occured.try again!');</script>";   
